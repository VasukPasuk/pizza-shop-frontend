    ...
    <section className="intro_section">
      <div className="intro_left-block">
        ...
        <h2 className="intro_subtitle">
          We offer the freshest and tastiest pizza,
          prepared with love and attention to every detail. Our range
          includes classic favorite pizzas, gourmet masterpieces and
          vegetarian options for the most demanding tastes.
        </h2>
