...
function Footer() {
  ...
  return (
    ...
    >
      <div className="footer-up">
        <div className="footer-column inform-col">
          ...
          <div className="footer-column-body">
            We offer the tastiest pizza from the freshest ingredients, prepared with love and delivered right to your
            doorstep. Order from us and enjoy real pizza.
          </div>
        </div>
      ...
      >
        © 2024 Online Pizza Shop. All rights reserved.
      </div>
    </footer>
  );
}
